...
# Btw, what's the difference between operator overloading and dynamic
# dispatching?

# Suppose in Java, I have a Class called Chicken, and I want to compare
# chickens. 

# Java has a comparison function called :

# bool equals(Object o) { ... }

# So I will overwrite it:

# class Chicken{ bool equals(Object o) { ... } }


Object c1 = new Chicken(...);
